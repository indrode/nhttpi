...
# All request methods accept an <tt>NHTTPI::Request</tt> and an optional adapter.
# They may also offer shortcut methods for executing basic requests.
# Also they all return an <tt>NHTTPI::Response</tt>.
#
# == GET
#
#   request = NHTTPI::Request.new :url => "http://example.com"
#   NHTTPI.get request, :httpclient
#
# === Shortcuts
#
#   NHTTPI.get "http://example.com", :curb
#
# == POST
#
...
#
#   NHTTPI.post request, :httpclient
#
# === Shortcuts
#
#   NHTTPI.post "http://example.com", "<some>xml</some>", :curb
#
# == HEAD
#
#   request = NHTTPI::Request.new :url => "http://example.com"
#   NHTTPI.head request, :httpclient
#
# === Shortcuts
#
#   NHTTPI.head "http://example.com", :curb
#
# == PUT
#
#   request = NHTTPI::Request.new
...
#   request.body = "<some>xml</some>"
#
#   NHTTPI.put request, :httpclient
#
# === Shortcuts
#
#   NHTTPI.put "http://example.com", "<some>xml</some>", :curb
#
# == DELETE
#
#   request = NHTTPI::Request.new :url => "http://example.com"
#   NHTTPI.delete request, :httpclient
#
# === Shortcuts
#
#   NHTTPI.delete "http://example.com", :curb
#
# == More control
#
...
module NHTTPI
  ...
  private
    ...
    # Checks whether +args+ contains of an <tt>NHTTPI::Request</tt> or a URL
    # and a request body plus an optional adapter and returns an Array with
    # an <tt>NHTTPI::Request</tt> and (if given) an adapter.
    ...
    def with_adapter(method, request, adapter)
      ...
      log :debug, "NHTTPI executes HTTP #{method.to_s.upcase} using the #{adapter} adapter"
