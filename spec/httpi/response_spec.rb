require "spec_helper"
require "nhttpi/response"

describe NHTTPI::Response do

  context "normal" do
    let(:response) { NHTTPI::Response.new 200, {}, Fixture.xml }
    ...
    describe "#code" do
      ...
      it "always returns an Integer" do
        response = NHTTPI::Response.new "200", {}, ""
        response.code.should == 200
      end
    end
  ...
  context "empty" do
    let(:response) { NHTTPI::Response.new 204, {}, nil }
  ...
  context "multipart" do
    let(:response) { NHTTPI::Response.new 200, { "Content-Type" => "multipart/related" }, "multipart" }
  ...
  context "error" do
    let(:response) { NHTTPI::Response.new 404, {}, "" }
  ...
  context "gzipped" do
    let(:response) { NHTTPI::Response.new 200, { "Content-Encoding" => "gzip" }, Fixture.gzip }
  ...
  context "DIME" do
    let(:response) { NHTTPI::Response.new 200, { "Content-Type" => "application/dime" }, Fixture.dime }
