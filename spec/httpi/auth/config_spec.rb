require "spec_helper"
require "nhttpi/auth/config"

describe NHTTPI::Auth::Config do
  let(:auth) { NHTTPI::Auth::Config.new }
  ...
  describe "#ssl" do
    it "returns the NHTTPI::Auth::SSL object" do
      auth.ssl.should be_a(NHTTPI::Auth::SSL)
    end
  end
