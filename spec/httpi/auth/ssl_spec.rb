require "spec_helper"
require "nhttpi/auth/ssl"

describe NHTTPI::Auth::SSL do

  describe "VERIFY_MODES" do
    it "contains the supported SSL verify modes" do
      NHTTPI::Auth::SSL::VERIFY_MODES.should == [:none, :peer, :fail_if_no_peer_cert, :client_once]
    end
  end

  describe "#present?" do
    it "defaults to return false" do
      ssl = NHTTPI::Auth::SSL.new
